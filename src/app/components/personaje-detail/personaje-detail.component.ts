...
@Component({
  ...
  imports: [IonGrid, IonCardContent, IonContent, IonCard, IonCardSubtitle, IonCardTitle, IonCardHeader, IonToolbar, IonButtons, IonBackButton, IonTitle, IonHeader, IonRow, IonCol, IonText],
